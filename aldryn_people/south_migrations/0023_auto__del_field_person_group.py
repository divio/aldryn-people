...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'aldryn_people_person', 'group_id')


    def backwards(self, orm):
        # Adding field 'Person.group'
        db.add_column(u'aldryn_people_person', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'persons', null=True, to=orm['aldryn_people.Group'], blank=True),
                      keep_default=False)
