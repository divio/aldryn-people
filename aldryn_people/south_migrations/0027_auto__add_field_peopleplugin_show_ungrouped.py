...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeoplePlugin.show_ungrouped'
        db.add_column(u'aldryn_people_peopleplugin', 'show_ungrouped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeoplePlugin.show_ungrouped'
        db.delete_column(u'aldryn_people_peopleplugin', 'show_ungrouped')
