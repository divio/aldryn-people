...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupTranslation.slug'
        db.add_column(u'aldryn_people_group_translation', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupTranslation.slug'
        db.delete_column(u'aldryn_people_group_translation', 'slug')
